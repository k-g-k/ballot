...
import { RC, ARG_FILTERS, ARG_FILTER_IDS } from "../../../data/tax-rebate-62f";
...
function AnalysisOpenQuestionsCard() {
  ...
  return (
    <Card title="Analysis & Open Questions">
      ...
      <SynthSourcesNote
        ids={["massBudget", "maoBrief", "mapleTestimony", "petition", "ballotpedia"]}
        prompt="Identify the points supporters and opponents of the 62F reform question agree on, the points they most disagree on, and the open questions the available evidence can't yet answer — across testimony, fiscal analysis, and the official text. Use only the sources listed below and cite nothing else. (Filler prompt for prototype purposes.)"
      />
    </Card>
  );
}
